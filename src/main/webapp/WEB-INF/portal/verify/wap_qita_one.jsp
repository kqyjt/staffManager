...
.yanzhengma_a{ font-size:12px; color:#fff; display:block; width:105px; height:28px; line-height:28px; margin-top:2px; text-align:center;  background:#73cc34;}
</style>
<body>
<section>
...
<p class="F14 c_red t_c" style=" padding:10px 0" id="errorMessage"></p>
 ...
 <table class="obertabler">
  <tr>
  <td><input id="SERIAL_NUMBER" class="obobere" placeholder="填写手机号码" type="text"></td>
  </tr>
  <tr>
   <!-- <td><a class="yanzhengma_a FR" href="javascript:void(0);" onclick="getPhoneVerifyCode();">获取验证码</a></td> -->
   <td><input type="button" class="yanzhengma_a FR" id="getCode" value="获取验证码" onclick="getPhoneVerifyCode(this);"/></td>
  </tr> 
  <tr> 
   <td><input id="CHECK_CODE" class="obobere" placeholder="填写验证码" type="text"></td>
  </tr>
 </table> 
 </div>
