...
<section>
<form class="loginregform" id="verifyform" name="verifyform" enctype="multipart/form-data"  action="${portalPath}/portal/space/VerifyMgr.htm?m=execute&f=addVerify" method="post" FormType="normalform" CommitType="form" CommitBtn="#submitbutton" MsgType="5">
...
<p class="F12 c_qhuise"><i class="fa fa-lightbulb-o c_orger"></i>&nbsp;为着照片通过率，勿使用任何美图功能对照片进行美化，拍摄上半身即可</p>
 ...
 <p class="c_shuise F14 t_c">将要实名的手机号码：<b class="c_orger" id="SERIAL_NUMBER"></b></p>
        ...
        <div class="yz-cont" style="width:230px; margin:25px auto">  
        	<span>请输入验证码：</span>
 ...
 <div style="width:160px; margin:25px auto">
 	<!-- <a class="button_red_gwc" href="javascript:void(0);" id = "submitbutton" onclick="initQita2();">提交</a> -->
 	<input class="button_red_gwc" type = "button" value = "提交" id = "submitbutton" onclick = "initQita2()"/>
 </div>
 </div>
</div> 
