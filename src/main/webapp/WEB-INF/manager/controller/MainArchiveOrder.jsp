...
<script type="text/javascript">
	...
	TOMAIN_PUBLIC.queryUrl = managerPath + "/manager/controller/TOMainMgr.json?m=execute&f=mainArchiveQuery";
...
TOMAIN_PUBLIC.updateActions=function(index){
	$('#ddcx-datagrid').datagrid('updateRow',{
		...
		TOMAIN_PUBLIC.grid=$('#ddcx-datagrid').datagrid({
		    ...
		    url: managerPath+'/manager/controller/TOMainMgr.json?m=execute&f=mainArchiveQuery',
		    //sortName: 'ID',  
		    //sortOrder: 'asc', 
		    loadMsg:'数据加载中...',
		    remoteSort:false,   
