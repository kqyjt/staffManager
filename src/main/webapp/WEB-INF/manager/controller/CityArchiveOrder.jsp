...
<div class="chaxun_cont">
 ...
 <li><span>订单渠道：</span>
  ...
  <li>
  	<span>地市名称：</span>
  	<select class="easyui-combobox" id="tomain_name" name="name">
  		<option value="">请选择</option>
...
<script type="text/javascript">
	...
	TOMAIN_PUBLIC.queryUrl = managerPath + "/manager/controller/TOMainMgr.json?m=execute&f=cityArchiveQuery";
...
TOMAIN_PUBLIC.searchOrder = function(){
	...
	TOMAIN_PUBLIC.params.name = $('#tomain_name').combobox('getValue');
	...
	$('#ddcx-datagrid').datagrid('updateRow',{
		...
		row:{}
			...
			TOMAIN_PUBLIC.grid=$('#ddcx-datagrid').datagrid({
			    ...
			    url: managerPath+'/manager/controller/TOMainMgr.json?m=execute&f=cityArchiveQuery',
			    //sortName: 'ID',  
			    //sortOrder: 'asc', 
			    loadMsg:'数据加载中...',
			    remoteSort:false,   
