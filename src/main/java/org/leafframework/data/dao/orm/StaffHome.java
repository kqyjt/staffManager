 ...
 * @see org.leafframework.data.dao.orm.Staff
...
public class StaffHome {
	...
	public List findAll() {
		log.debug("findAll Staff instance");
		try {
			return sessionFactory.getCurrentSession()
					.createQuery("from " + Staff.class.getName()).list();
		} catch (RuntimeException re) {
	...
	public Staff findById(java.lang.Integer id) {
		...
		try {
			Staff instance = (Staff) sessionFactory.getCurrentSession().get(
					"org.leafframework.data.dao.orm.Staff", id);
			if (instance == null) {
	...
	public List findByExample(Staff instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("org.leafframework.data.dao.orm.Staff")
